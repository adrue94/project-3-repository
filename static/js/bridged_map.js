  ...
  .then(data => {
    ...
    var eighth_grade_or_less = new L.GeoJSON(null, {
      ...
      onEachFeature: function (feature, layer) {
        ...
        d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
          var educationData = data.find(function(d) {
            return d.State === state && d.EduLevelCode === 1;
            //CHANGE THE EDUCATION LEVEL CODE --------------------------------------------------- - USE STRING
          });
         
          if (educationData) {
            var birthsByEducationLevel = +educationData.Births;
    ...
    var ninth_no_diploma = new L.GeoJSON(null, {
        ...
        onEachFeature: function (feature, layer) {
          ...
          d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
            var educationData = data.find(function(d) {
              return d.State === state && d.EduLevelCode === 2;
            });
    ...
    var bachelors = new L.GeoJSON(null, {
        ...
        onEachFeature: function (feature, layer) {
          ...
          d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
            var educationData = data.find(function(d) {
              return d.State === state && d.EduLevelCode === 6;
    ...
    var doctorate_professional = new L.GeoJSON(null, {
        ...
        onEachFeature: function (feature, layer) {
          ...
          d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
            var educationData = data.find(function(d) {
              return d.State === state && d.EduLevelCode === 8;
              //CHANGE THE EDUCATION LEVEL CODE --------------------------------------------------- - USE STRING
            });
    ...
    var highschool_ged = new L.GeoJSON(null, {
        ...
        onEachFeature: function (feature, layer) {
          ...
          d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
            var educationData = data.find(function(d) {
              return d.State === state && d.EduLevelCode === 3;
              //CHANGE THE EDUCATION LEVEL CODE --------------------------------------------------- - USE STRING
            });
    ...
    var masters = new L.GeoJSON(null, {
        ...
        onEachFeature: function (feature, layer) {
          ...
          d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
            var educationData = data.find(function(d) {
              return d.State === state && d.EduLevelCode === 7;
              //CHANGE THE EDUCATION LEVEL CODE --------------------------------------------------- - USE STRING
            });
    ...
    var some_college_no_degree = new L.GeoJSON(null, {
        ...
        onEachFeature: function (feature, layer) {
          ...
          d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
            var educationData = data.find(function(d) {
              return d.State === state && d.EduLevelCode === 4;
              //CHANGE THE EDUCATION LEVEL CODE --------------------------------------------------- - USE STRING
            });
  ...
  //END COPY PER EDUCATION -------------------------------------------------------------------
   ...
   var associates = new L.GeoJSON(null, {
    ...
    onEachFeature: function (feature, layer) {
      ...
      d3.json('http://127.0.0.1:5000/api/v1.0/state_births_merged_years').then(function(data) {
        var educationData = data.find(function(d) {
          return d.State === state && d.EduLevelCode === 5;
          //CHANGE THE EDUCATION LEVEL CODE!!! ---------------------------------------------
        });
